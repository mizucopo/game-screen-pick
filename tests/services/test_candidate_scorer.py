...
def test_candidate_scorer_penalizes_transition_like_low_confidence_candidate() -> None:
    ...
    clean = scorer.score(
        ...
        assessment=SceneAssessment(
            ...
            relative_bright_transition_score=0.02,
            relative_dark_transition_score=0.01,
            relative_transition_score=0.02,
    ...
    bad = scorer.score(
        ...
        assessment=SceneAssessment(
            ...
            relative_bright_transition_score=0.71,
            relative_dark_transition_score=0.09,
            relative_transition_score=0.71,
            relative_transition_polarity="bright",
