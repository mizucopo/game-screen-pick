...
def restore_candidate_annotation(
    ...
    typed_combat_encounter_basis = combat_encounter_basis
    if (
        not combat_encounter_classification_is_valid(
            typed_combat_encounter_kind,
            typed_combat_encounter_basis,
        )
